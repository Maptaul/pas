...
const PassportApplicationForm = () => {
  ...
  const nextStep = () => {
    ...
    if (step === 2 && (!formData.applicationFormNumber || !formData.onlineRegistrationId || !formData.fullName || !formData.dateOfBirth)) {
    ...
    if (step === 3 && formData.previousPassport.startsWith("Yes") && (!formData.reissueReason || !formData.passportNumber || !formData.issueDate || !formData.expiryDate)) {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      !formData.applicationFormNumber ||
      !formData.onlineRegistrationId ||
      !formData.fullName ||
  ...
  return (
    <div className="container mx-auto p-4 pt-16 flex flex-col md:flex-row gap-6">
      {/* Vertical Step Bar */}
      <div className="md:w-1/4">
        <div className="steps steps-vertical">
          <div className={`step ${step >= 1 ? "step-primary" : ""}`}>
            <div className="text-gray-800 font-poppins">Passport Type</div>
          </div>
          <div className={`step ${step >= 2 ? "step-primary" : ""}`}>
            <div className="text-gray-800 font-poppins">Personal Information</div>
          </div>
          <div className={`step ${step >= 3 ? "step-primary" : ""}`}>
            <div className="text-gray-800 font-poppins">Previous Passport</div>
          </div>
          <div className={`step ${step >= 4 ? "step-primary" : ""}`}>
            <div className="text-gray-800 font-poppins">Passport Options</div>
          </div>
          <div className={`step ${step >= 5 ? "step-primary" : ""}`}>
            <div className="text-gray-800 font-poppins">Documents</div>
          </div>
          <div className={`step ${step >= 6 ? "step-primary" : ""}`}>
            <div className="text-gray-800 font-poppins">Delivery Options</div>
          </div>
          <div className={`step ${step >= 7 ? "step-primary" : ""}`}>
            <div className="text-gray-800 font-poppins">Exclusive Service</div>
          </div>
          <div className={`step ${step >= 8 ? "step-primary" : ""}`}>
            <div className="text-gray-800 font-poppins">Review & Submit</div>
          </div>
        </div>
      </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  <div className="form-control">
                    <label className="label">
                      <span className="label-text font-poppins">Application Form Number</span>
                    </label>
                    <input
                      type="text"
                      name="applicationFormNumber"
                      value={formData.applicationFormNumber}
                      onChange={handleInputChange}
                  ...
                  <div className="form-control">
                    <label className="label">
                      <span className="label-text font-poppins">Online Registration ID</span>
                    </label>
                    <input
                      type="text"
                      name="onlineRegistrationId"
                      value={formData.onlineRegistrationId}
                      onChange={handleInputChange}
              ...
              <div>
                ...
                {formData.previousPassport.startsWith("Yes") && (
                  <div className="mt-6 space-y-4">
                    <div className="form-control">
                      <label className="label">
                        <span className="label-text font-poppins">What is the reason for your passport request?</span>
                      </label>
                      <select
                        name="reissueReason"
                      ...
                      >
                        ...
                        <option value="Conversion to ePassport">Conversion to ePassport</option>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="form-control">
                        <label className="label">
                          <span className="label-text font-poppins">Previous Passport Number</span>
                        </label>
                        <input
                          type="text"
                          name="passportNumber"
                      ...
                      <div className="form-control">
                        <label className="label">
                          <span className="label-text font-poppins">Date of Issue</span>
                        </label>
                        <input
                          type="date"
                          name="issueDate"
                      ...
                      <div className="form-control">
                        <label className="label">
                          <span className="label-text font-poppins">Date of Expiration</span>
                        </label>
                        <input
                          type="date"
                          name="expiryDate"
            ...
            {step === 5 && (
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  ...
                  <div className="form-control">
                    <label className="label">
                      <span className="label-text font-poppins">Previous Passport (if applicable)</span>
                    </label>
                    <input
                      type="file"
                      name="previousPassport"
                  ...
                  <div className="form-control">
                    <label className="label">
                      <span className="label-text font-poppins">Online GD (if applicable)</span>
                    </label>
                    <input
                      type="file"
                      name="onlineGD"
            ...
            {step === 7 && (
              <div>
                ...
                {formData.exclusiveService === "Yes" && (
                  <div className="mb-6">
                    <p className="text-gray-700 font-poppins">
                      <strong>Regular Delivery (15 days):</strong> 8000 BDT
                    </p>
                    <p className="text-gray-700 font-poppins">
                      <strong>Express Delivery (10 days):</strong> 12000 BDT
                    </p>
                  </div>
                )}
                <div className="mt-8 flex justify-between">
              ...
              <div>
                ...
                <div className="mb-6 space-y-4">
                  <div className="border-b pb-2">
                    <h3 className="text-lg font-semibold text-purple-600 font-poppins">Passport Type</h3>
                    <p className="text-gray-700 font-poppins">{formData.passportType}</p>
                  </div>
                  <div className="border-b pb-2">
                    <h3 className="text-lg font-semibold text-purple-600 font-poppins">Personal Information</h3>
                    <p className="text-gray-700 font-poppins"><strong>Application Form Number:</strong> {formData.applicationFormNumber}</p>
                    <p className="text-gray-700 font-poppins"><strong>Online Registration ID:</strong> {formData.onlineRegistrationId}</p>
                    <p className="text-gray-700 font-poppins"><strong>Full Name:</strong> {formData.fullName}</p>
                    <p className="text-gray-700 font-poppins"><strong>Date of Birth:</strong> {formData.dateOfBirth}</p>
                  </div>
                  <div className="border-b pb-2">
                    <h3 className="text-lg font-semibold text-purple-600 font-poppins">Previous Passport</h3>
                    <p className="text-gray-700 font-poppins">
                      <strong>Has Previous Passport:</strong> {formData.previousPassport === "Yes-MRP" ? "Yes, I have a Machine Readable Passport (MRP)" : formData.previousPassport === "Yes-ePP" ? "Yes, I have an Electronic Passport (ePP)" : "No, I don't have any previous passport / handwritten passport"}
                    </p>
                    {formData.previousPassport.startsWith("Yes") && (
                      <>
                        <p className="text-gray-700 font-poppins"><strong>Reissue Reason:</strong> {formData.reissueReason}</p>
                        <p className="text-gray-700 font-poppins"><strong>Passport Number:</strong> {formData.passportNumber}</p>
                        <p className="text-gray-700 font-poppins"><strong>Issue Date:</strong> {formData.issueDate}</p>
                        <p className="text-gray-700 font-poppins"><strong>Expiry Date:</strong> {formData.expiryDate}</p>
                      </>
                    )}
                  </div>
                  <div className="border-b pb-2">
                    <h3 className="text-lg font-semibold text-purple-600 font-poppins">Passport Options</h3>
                    <p className="text-gray-700 font-poppins"><strong>Passport Pages:</strong> {formData.passportPages} pages</p>
                    <p className="text-gray-700 font-poppins"><strong>Validity:</strong> {formData.validity} years</p>
                  </div>
                  <div className="border-b pb-2">
                    <h3 className="text-lg font-semibold text-purple-600 font-poppins">Documents</h3>
                    <p className="text-gray-700 font-poppins"><strong>Application Copy:</strong> {files.applicationCopy ? files.applicationCopy.name : "Not uploaded"}</p>
                    <p className="text-gray-700 font-poppins"><strong>NID/Birth Certificate:</strong> {files.nidBirthCertificate ? files.nidBirthCertificate.name : "Not uploaded"}</p>
                    <p className="text-gray-700 font-poppins"><strong>NID Online Copy:</strong> {files.nidOnlineCopy ? files.nidOnlineCopy.name : "Not uploaded"}</p>
                    <p className="text-gray-700 font-poppins"><strong>Student/Job Card:</strong> {files.studentJobCard ? files.studentJobCard.name : "Not uploaded"}</p>
                    <p className="text-gray-700 font-poppins"><strong>Father NID/Birth Certificate:</strong> {files.fatherNidBirthCertificate ? files.fatherNidBirthCertificate.name : "Not uploaded"}</p>
                    <p className="text-gray-700 font-poppins"><strong>Mother NID/Birth Certificate:</strong> {files.motherNidBirthCertificate ? files.motherNidBirthCertificate.name : "Not uploaded"}</p>
                    <p className="text-gray-700 font-poppins"><strong>Utility Bill Copy:</strong> {files.utilityBillCopy ? files.utilityBillCopy.name : "Not uploaded"}</p>
                    <p className="text-gray-700 font-poppins"><strong>Previous Passport:</strong> {files.previousPassport ? files.previousPassport.name : "Not uploaded"}</p>
                    <p className="text-gray-700 font-poppins"><strong>Land Register:</strong> {files.landRegister ? files.landRegister.name : "Not uploaded"}</p>
                    <p className="text-gray-700 font-poppins"><strong>Citizenship Certificate:</strong> {files.citizenshipCertificate ? files.citizenshipCertificate.name : "Not uploaded"}</p>
                    <p className="text-gray-700 font-poppins"><strong>Online GD:</strong> {files.onlineGD ? files.onlineGD.name : "Not uploaded"}</p>
                  </div>
                  <div className="border-b pb-2">
                    <h3 className="text-lg font-semibold text-purple-600 font-poppins">Delivery Options</h3>
                    <p className="text-gray-700 font-poppins"><strong>Delivery Type:</strong> {formData.deliveryType}</p>
                  </div>
                  <div className="border-b pb-2">
                    <h3 className="text-lg font-semibold text-purple-600 font-poppins">Exclusive Service</h3>
                    <p className="text-gray-700 font-poppins"><strong>Exclusive Service:</strong> {formData.exclusiveService}</p>
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-purple-600 font-poppins">Total Price</h3>
                    <p className="text-gray-700 font-poppins">{calculateFinalPrice()} BDT</p>
                  </div>
                </div>
                <div className="mt-8 flex justify-between">
                  <button onClick={prevStep} className="btn btn-outline btn-purple">
